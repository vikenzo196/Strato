...
/* === CARRELLO VUOTO — reset finale page-flow, no residui sheet/layer assoluti === */
html.cart-empty-lock,
body.cart-empty-lock{
  width:100%;
  max-width:100%;
...
.cartemptypage .cartEmptyFull{
  ...
  padding:4px 18px calc(100px + env(safe-area-inset-bottom,0px))!important;
  overflow:hidden!important;
  overscroll-behavior:none!important;
...
.cartemptypage .cartEmptyFull::before{
  ...
  inset:0 8px calc(74px + env(safe-area-inset-bottom,0px))!important;
  border-radius:38px!important;
  pointer-events:none!important;
  z-index:0!important;
  background:
    radial-gradient(circle at 50% 38%, rgba(255,253,248,.22), transparent 42%),
    radial-gradient(circle at 50% 78%, rgba(199,125,107,.060), transparent 62%)!important;
}
...
.cartemptypage .cartEmptyFullContent p{
  position:relative!important;
  z-index:2!important;
  margin:0 auto!important;
...
.cartemptypage .cartEmptyFullArt{
  ...
  transform:none!important;
  flex:0 0 auto!important;
  width:min(calc(100vw - 36px), 620px)!important;
  max-width:620px!important;
  height:clamp(214px, 32svh, 330px)!important;
...
body.dark .cartemptypage .cartEmptyFull::before{
  background:
    radial-gradient(circle at 50% 38%, rgba(199,125,107,.085), transparent 44%),
    radial-gradient(circle at 50% 78%, rgba(255,238,218,.034), transparent 64%)!important;
}
...
@media(max-height:760px){
  ...
  .cartemptypage .cartEmptyFullArt{
    height:clamp(188px, 29svh, 286px)!important;
...
@media(max-width:380px){
  ...
  .cartemptypage .cartEmptyFullArt{
    ...
    height:clamp(188px, 30svh, 292px)!important;
  }
}
`;
