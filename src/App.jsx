...
export default function App() {
  ...
  const syncBackstop = () => {
    try {
      ...
      // Backstop tinta unita sull'<html> (copre overscroll e bordi).
      root.style.background = base;
      root.style.backgroundColor = base;
      root.style.backgroundImage = "none";
      // Wallpaper frosted come immagine RASTER che SCORRE col contenuto
      // (background-attachment:scroll, NON fixed): nessun layer ancorato al
      // viewport = nessun ridisegno parziale = nessuna linea netta.
      body.style.backgroundColor = base;
      body.style.backgroundImage = "url(" + (dark ? WP_DARK : WP_LIGHT) + ")";
