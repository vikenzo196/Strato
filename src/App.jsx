...
/* ===================== CARRELLO VUOTO — earth tone ambient art =====================
   Illustrazione decorativa derivata dal visual carrello, tintata con palette Strato.
   Solo empty state: non tocca carrello pieno, ordini, home o logiche. */
.cartEmptyState{
  position:relative;
  min-height:430px;
  display:grid;
...
.cartEmptyState::before{
  ...
  border-radius:32px;
  background:
    radial-gradient(circle at 50% 34%, rgba(255,253,249,.42), transparent 44%),
    radial-gradient(circle at 50% 92%, rgba(199,125,107,.09), transparent 62%);
  opacity:.9;
  z-index:0;
  pointer-events:none;
}
...
.cartEmptyArt{
  ...
  background-image:url("data:image/webp;base64,");
  background-repeat:no-repeat;
...
.cartEmptyState .cartempty-action{
  min-width:150px;
  height:48px;
  border-radius:999px;
  border:1px solid rgba(199,125,107,.18);
  background:
    linear-gradient(180deg, rgba(199,125,107,.82), rgba(148,101,74,.82)),
    rgba(199,125,107,.28);
  color:#fffaf4;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.26),0 12px 26px rgba(112,72,48,.18);
}

body.dark .cartEmptyState::before{
  background:
    radial-gradient(circle at 50% 30%, rgba(199,125,107,.10), transparent 44%),
    radial-gradient(circle at 50% 88%, rgba(255,238,218,.045), transparent 62%);
  opacity:.82;
}

body.dark .cartEmptyArt{
  background-image:url("data:image/webp;base64,");
  opacity:.38;
  mix-blend-mode:screen;
  filter:saturate(.88) contrast(.9);
}

body.dark .cartEmptyTitle{
  color:var(--text);
}

body.dark .cartEmptyText{
  color:var(--soft);
}

body.dark .cartEmptyState .cartempty-action{
  border-color:rgba(199,125,107,.30);
  background:
    linear-gradient(180deg, rgba(157,105,73,.72), rgba(108,73,52,.72)),
    rgba(199,125,107,.18);
  color:var(--text);
  box-shadow:inset 0 1px 0 rgba(255,238,218,.12),0 15px 32px rgba(0,0,0,.22);
}

@media(max-width:380px){
  .cartEmptyState{min-height:400px;padding-top:24px}
  .cartEmptyArt{width:126%;bottom:0}
  .cartEmptyTitle{font-size:23px}
}

@media(prefers-reduced-motion:reduce){
  .cartEmptyArt{transform:translate3d(-50%,0,0)}
}
        ...
        <div className="cartitems">
          {cart.length === 0 && (
            <div className="cartEmptyState">
              <div className="cartEmptyArt" aria-hidden="true" />
              <div className="cartEmptyContent">
                <div className="cempty cartEmptyTitle">Il carrello è vuoto.</div>
                <p className="cartEmptyText">Quando sceglierai un oggetto, lo ritroverai qui.</p>
                <button className="cartempty-action" onClick={onGoExplore}>Esplora</button>
              </div>
            </div>
          )}
          {cart.map((c, i) => {
